package viladrich.arnau.calculadora;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b_del, b_AC, b_suma, b_resta, b_multi, b_divisio, b_coma, b_equal, b_esq, b_dret, b_ans;
    TextView pantalla;
    int cont, pos_coma, cont_prioritat=0, cont_operadors, i, j, cont_sumes;
    ...
    Boolean coma_pitjada=false, ep_infinit=false, V_Op, already_op=false, no_escrit=true, resultat_actiu=false, anterior_V, hiHaPrioritat = true; //valor true, operacio false
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_esq = (Button) findViewById(R.id.num_esq);
        b_dret = (Button) findViewById(R.id.num_dret);
        ...
        b_esq.setOnClickListener(this);
        b_dret.setOnClickListener(this);
    ...
    public void pulsemAns(){   // VA BÉ
        ...
        if(!anterior_V && cont!=0) {
            ...
            V_Op = true;                                         //dona permis per poder continar escrivint
    ...
    public void pulsemDel(){   //esborrar tota la cela de l'array o un per un?
        ...
        if(cont > 0) {
            ...
            //cal comparar un array amb l'altre



            //que pasa dins l'array? cal mirar si un cop esborrat ens trobem en una cela o altre de l'array
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.num_esq: valor ="("; escriureOperands(); break;
            case R.id.num_suma: valor="+"; escriureOperands(); break;
            case R.id.num_dret: valor=")"; escriureOperands(); break;
